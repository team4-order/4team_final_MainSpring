...
public interface ContactRepository extends JpaRepository<Contact, String> {
    ...
    @Query("SELECT c FROM Contact c WHERE c.contactDelimiter = 'C' AND c.contactName LIKE %:contactName%")
    List<Contact> findByContactDelimiterAndContactNameStartingWith(String contactName);
